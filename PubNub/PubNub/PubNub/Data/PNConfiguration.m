...
- (id)initWithOrigin:(NSString *)originHostName publishKey:(NSString *)publishKey subscribeKey:(NSString *)subscribeKey
    ...
    if((self = [super init])) {
        ...
        self.historyRequestTimeout = kPNHistoryRequestTimeout;
...
- (void)migrateConfigurationFrom:(PNConfiguration *)configuration {
    ...
    self.historyRequestTimeout = configuration.historyRequestTimeout;
...
- (BOOL)isEqual:(PNConfiguration *)configuration {
    ...
    isEqual = (isEqual ? (self.historyRequestTimeout == configuration.historyRequestTimeout) : isEqual);

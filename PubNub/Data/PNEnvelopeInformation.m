...
return @{@"Shard identifier": (self.shardIdentifier?: @""),
@"Flags": (self.debugFlags?: @""),
@"Client Identifier": (self.senderIdentifier?: @""),
@"Sequence number": (self.sequenceNumber?: @""),
@"Subscribe key": (self.subscribeKey?: @""),
@"Replication map": (self.replicationMap?: @""),
@"Eat after reading": (self.eatAfterReading ? (self.shouldEatAfterReading ? @"YES" : @"NO") : @""),
@"Metadata": (self.metadata ? [PNJSON JSONStringFrom:self.metadata withError:nil] : @""),
@"Waypoints": (self.waypoints ? [PNJSON JSONStringFrom:self.waypoints withError:nil] : @"")};
}
